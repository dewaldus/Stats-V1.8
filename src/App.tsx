...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 flex font-sans text-stone-900 dark:text-stone-100 transition-colors duration-300">
      {/* Sidebar */}
      <aside className="w-72 bg-white dark:bg-stone-900 border-r border-stone-200 dark:border-stone-800 flex flex-col sticky top-0 h-screen z-20">
        ...
        <nav className="flex-1 p-6 space-y-8 overflow-y-auto">
          ...
          <div className="space-y-3">
            <p className="px-3 text-[10px] font-black text-stone-400 dark:text-stone-600 uppercase tracking-[0.2em]">Advanced</p>
            <NavButton id="bayes" icon={BrainCircuit} label="Bayes' Theorem" color="amber" />
          </div>

          <div className="space-y-3">
            <p className="px-3 text-[10px] font-black text-stone-400 dark:text-stone-600 uppercase tracking-[0.2em]">Continuous</p>
            <div className="space-y-1">
          ...
          <div className="space-y-3">
            <p className="px-3 text-[10px] font-black text-stone-400 dark:text-stone-600 uppercase tracking-[0.2em]">Discrete</p>
            <div className="space-y-1">
        ...
        <div className="p-6 border-t border-stone-100 dark:border-stone-800/50 bg-stone-50/50 dark:bg-stone-900/50">
          ...
          >
            ...
            <div className="w-10 h-6 bg-stone-100 dark:bg-stone-700 rounded-full p-1 relative transition-colors duration-300">
              <motion.div
